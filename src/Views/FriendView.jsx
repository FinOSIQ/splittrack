    ...
    <div className="flex min-h-screen bg-white">
      ...
      <main className="flex-1 p-8 mr-16">
        ...
        <div className="w-[1145px] h-[333px] bg-[#f1f2f9] rounded-xl p-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center">
                <img src="src/images/3d_avatar_18.png" alt="profile" class="w-[99.57px] h-[90px]" />
                <div>
          ...
          <div className="mt-4 flex space-x-16" style={{ marginTop: '8rem' }}>
            <button
              onClick={() => setActiveTab('settleUp')}
              className={`px-20 py-2 rounded-3xl ${activeTab === 'settleUp' ? 'bg-[#040B2B] text-white' : 'bg-gray-200'}`}
            >
              Settle Up
            </button>
            <button
