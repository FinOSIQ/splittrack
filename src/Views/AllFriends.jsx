...
export default function AllFriends() {
    ...
    useEffect(() => {
        if (contentRef.current) {
            // Determine direction based on current tab
                ...
                <div className="xl:w-[70%] lg:w-[60%] w-full  md:px-3 px-1 xl:h-[78vh] lg:h-[76vh]">
                    <div className="h-full rounded-2xl p-4 overflow-hidden">
                        ...
                        <div className="flex border-b border-gray-300 lg:hidden">
                            <button
                                className={`px-6 py-3 text-lg font-bold ${activeTab === "friends" ? "text-[#040b2b] border-b-2 border-[#040b2b]" : "text-gray-500"}`}
                                onClick={() => setActiveTab("friends")}
                            >
                                Friends
                            </button>
                            <button
                                className={`px-6 py-3 text-lg font-bold ${activeTab === "friendRequests" ? "text-[#040b2b] border-b-2 border-[#040b2b]" : "text-gray-500"}`}
