        ...
        <div className="flex justify-center items-center p-4">
            <div className="bg-white rounded-xl shadow-md p-4 w-full max-w-md">
                <div className="flex items-center mb-2">
                    <img className="w-12 h-12 rounded-full mr-4" src="https://placehold.co/43x43" alt="Group Avatar" />
                    <div>
                ...
                <div className="text-xs text-[#5c5470] mb-4">
                    <p>Sonal Attanayake</p>
                    <p>Shehan Rajapaksha</p>
                    <p className="font-light">+2 more</p>
                </div>
                <div className="flex justify-between items-center">
                    <button className="px-3 py-1 bg-white border border-[#5c5470] rounded text-xs font-medium text-[#5c5470]">View Details</button>
                    <div className="text-right">
                        <p className="text-sm text-[#040b2b] font-medium">You Owe</p>
